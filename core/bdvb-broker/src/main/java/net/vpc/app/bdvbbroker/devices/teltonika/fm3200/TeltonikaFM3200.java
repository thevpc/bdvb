 ...
 */
public class TeltonikaFM3200 extends SimpleBdvbDeviceDriver {
    public TeltonikaFM3200() {
        super(new TeltonikaFM3200TcpDecoder(),
                "{\"services\":{\"net.vpc.app.bdvbbroker.devices.teltonika.fm3200.TeltonikaFM3200\":{\"protocol\":\"tcp\",\"port\":1234}}}"
        );
    }
