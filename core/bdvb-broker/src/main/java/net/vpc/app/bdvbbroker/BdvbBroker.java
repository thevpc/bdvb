...
public interface BdvbBroker {
    ...
    BdvbDeviceDriver register(Class<? extends BdvbDeviceDriver> driverClass);
    ...
    void addService(String id,String driverDefaultName, JsonObject config);
    ...
    void addPacketHandler(BdvbPacketHandler handler);

    void removePacketHandler(BdvbPacketHandler handler);
