 ...
 */
public class BdvbBrokerServerClearTest {
    public static void main(String[] args) {
        BdvbRepository r=new BdvbRepositoryMongodb();
        r.start(null);
        r.resetPackets(null,null);
        r.stop();
//        BdvbBroker broker = Bdvb.createBroker();
...
//        broker.start();
//        broker.getRepository().resetPackets();
//        broker.stop();
    }
}
